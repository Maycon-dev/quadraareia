<?php    
    ...
    try {
        ...
        $result = $db->dbDelete("DELETE FROM metodo_pagamento 
                                WHERE id = ?",
                                [$_POST['id']]
                            );
        ...
        if ($result) {
            return header("Location: listaMetodoPagamento.php?msgSucesso=Registro excluído com sucesso.");
        } else {
            return header("Location: listaMetodoPagamento.php?msgError=Falha ao tentar excluír o registro.");
        }
