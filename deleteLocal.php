<?php    
    ...
    try {
        ...
        $result = $db->dbDelete("DELETE FROM local 
                                WHERE id = ?",
                                [$_POST['id']]
                            );
        ...
        if ($result) {
            return header("Location: listaLocal.php?msgSucesso=Registro excluído com sucesso.");
        } else {
            return header("Location: listaLocal.php?msgError=Falha ao tentar excluír o registro.");
        }
