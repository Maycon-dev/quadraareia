<?php    
    ...
    try {
        ...
        $result = $db->dbDelete("DELETE FROM horario 
                                WHERE id = ?",
                                [$_POST['id']]
                            );
        ...
        if ($result) {
            return header("Location: listaHorario.php?msgSucesso=Registro excluído com sucesso.");
        } else {
            return header("Location: listaHorario.php?msgError=Falha ao tentar excluír o registro.");
        }
