<?php
    ...
    */
    if ($_GET['acao'] != "insert") {
        ...
        $dados = $db->dbSelect("SELECT * FROM tipo_local WHERE id = ?", 'first', [$_GET['id']]);
    }
    ...
    <div class="page-wrapper mt-4">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title">Editar Tipo Local<?= subTitulo($_GET['acao']) ?></h4>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form class="g-3" action="<?= $_GET['acao'] ?>TipoLocal.php" method="POST" 
