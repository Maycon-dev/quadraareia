<?php    
    ...
    try {
        ...
        $result = $db->dbDelete("DELETE FROM penalidade 
                                WHERE id = ?",
                                [$_POST['id']]
                            );
        ...
        if ($result) {
            return header("Location: listaPenalidade.php?msgSucesso=Registro excluído com sucesso.");
        } else {
            return header("Location: listaPenalidade.php?msgError=Falha ao tentar excluír o registro.");
        }
